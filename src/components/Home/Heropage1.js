...
import { PROFILE_IMG_URL, WHATSAPP_URL, RESUME_DOWNLOAD_LINK } from "../../utils/constants";
...
const HeroPage1 = () => {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      {/* Main Content */}
      <div className="relative z-10 flex justify-center items-center min-h-screen text-center px-6 sm:px-10">
        <div className="hero flex flex-col lg:flex-row justify-between bg-transparent min-h-screen">
          <div className="hero-content flex flex-col lg:flex-row items-center lg:items-start">
            {/* Profile Image */}
            <img
              alt="profile"
              src={PROFILE_IMG_URL}
              className="max-w-xs sm:max-w-sm rounded-full hover:scale-95 shadow-2xl mb-6 lg:mb-0"
            />
            <div className="flex flex-col justify-center ml-0 lg:ml-20 w-full lg:w-auto">
              <div className="flex flex-col justify-start">
                <h1 className={`${ThemeTextColor} text-3xl sm:text-4xl lg:text-5xl`}>Hi,</h1>
                <h1 className={`text-4xl sm:text-5xl font-bold ${ThemeTextColor}`}>I'm, Tarun Bommali</h1>
              </div>
