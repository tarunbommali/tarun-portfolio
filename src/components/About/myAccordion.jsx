...
export default function MyAccordion() {
  ...
  return (
    <div className={`flex md:min-h-[100vh] flex-col mt-[18px] flex items-center py-3 ${textColor}`}>
      <h1 className="font-semibold text-left mb-5 text-lg md:text-3xl border-b-2 pb-2 border-blue-500">Common Inquiries</h1>
