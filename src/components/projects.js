...
class Projects extends Component {
  ...
  render() {
    ...
    return (
      ...
      <h1 className="p-3 font-semibold">Projects</h1>
    
        <ul className="flex justify-evenly items-center w-[80%] rounded-md bg-white flex-wrap m-3 p-3 ">
          {filteredProjects.map((project) => (
            <li className="flex flex-col items-start m-2 " key={project.id}>
              <img
              ...
              <div className="flex ">
              <a href={project.repositoryLink} target="__blank" rel="noopener" className="mr-2 text-[#5e5e5e]"><FaExternalLinkAlt/></a>
              <a href={project.projectLink} target="__blank" rel="noopener" className="mr-2 text-[#5e5e5e]"><FaFileCode/></a>
    </div>
              </div>
            </li>
