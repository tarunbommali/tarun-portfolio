  ...
  return (
    ...
    <Typewriter
      options={{
        ...
        autoStart: true,
        loop: true,
        wrapperClassName: `text-[28px] md:text-[42px] ${textColor}`,  // Apply dynamic text color
        cursorClassName: `text-[28px] md:text-[32px] ${cursorColor}`, // Apply dynamic cursor color
        delay: 250,
      }}
